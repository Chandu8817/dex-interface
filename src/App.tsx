      ...
      <div className="flex-1 flex flex-col">
        <div className="max-w-2xl w-full mx-auto px-4 sm:px-6 py-8 flex-1 flex flex-col">
          ...
          <header className="flex justify-between items-center mb-8">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Dex V3 Adapter</h1>
          ...
          {/* Mobile menu */}
          <div className="sm:hidden mb-6">{!isConnected && <CustomConnectButton />}</div>
          <div className="px-4 py-6 sm:px-0">
            {!isConnected ? (
              ...
              <div>
                ...
                {activeTab === 'pools' && (
                  <PoolsTab signer={signer} handleChangeSetActiveTab={setActiveTab} />
                )}
